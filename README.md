...
| [Docker](https://www.docker.com) | ![Swag](icons/swag.png) | Submit a new Docker extension or contribute to already existing [Docker extensions](https://github.com/docker/hacktoberfest-2022#%EF%B8%8Flist-of-docker-extensions-for-hacktoberfest-2022) repos. | [Details](https://docker.github.io/hacktoberfest/) |
| | | | |
| [Airbyte](https://airbyte.com/connector-contest) | ![Other](icons/other.png) ![Swag](icons/swag.png) | Build or edit a connector with the new low-code CDK to the [Airbyte connector repo](https://github.com/airbytehq/connector-contest) to win prize money and swag. Each submission will receive $500 and Airbyte swag. Three other prizes from $1,500 to $750 and Airbyte swag pack. | [Details](https://airbyte.com/connector-contest/) |
...
| [AppFlowy](https://www.appflowy.io/) | ![Shirt](icons/shirt.png) | If your PR fixes a bug or adds functionality or makes the codebase easier to use or understand you can claim your t-shirt by filling [this form.](https://tally.so/r/mKP5z3) | [Details](https://appflowy.gitbook.io/docs/essential-documentation/contribute-to-appflowy/contributing-to-appflowy#contributor-t-shirt) |
| [AppSmith](https://www.appsmith.com/) | ![Other](icons/other.png) | Earn coins as points for contributing, which can be redeemed in their swag shop at the end of the Hacktoberfest. | [Details](https://www.appsmith.com/blog/hacktoberfest-2022-come-on-in-the-low-code-is-fine) |
| [Atsign](https://atsign.com) | ![Other](icons/other.png) | Contribute towards open issues to win gift cards ranging from $10 to $50 USD. Total 21 winners. | [Details](https://atsign.com/atsign-hacktoberfest-2022/) |
...
| [Camunda](https://camunda.com) | ![Shirt](icons/shirt.png) ![Plant](icons/plant.png) | Submit four (4) quality pull requests (PRs) to any [Camunda repo](https://github.com/search?q=topic%3Ahacktoberfest+org%3Acamunda&type=Repositories) including participating [Camunda Community Hub repos](https://github.com/search?q=topic%3Ahacktoberfest+org%3Acamunda-community-hub&type=Repositories). For every Camunda challenge completion, we will make a donation to One Tree Planted which plants trees across the globe focusing on areas in need of habitat rehabilitation. If you complete the challenge you will also have the option of choosing to receive the limited edition Camunda x Hacktoberfest 2022 t-shirt.  | [Details](https://camunda.com/hacktoberfest2022/) |
| [Chimoney](https://chimoney.io) | ![Other](icons/other.png) ![Shirt](icons/shirt.png) ![Stickers](icons/stickers.png) | 🎃 Each merged PR gets $25 👻 Each contributor can get this gift up to four times ( 25 * 4 ) = $100 🔮 Bonus! A contributor completing 4 merged PRs gets a T-shirt. | [Details](https://github.com/Chimoney/chimoney-community-projects) |
...
| [Codédex](https://www.codedex.io/) | ![Other](icons/other.png) ![Shirt](icons/shirt.png) | Create interesting and engaging project tutorials for codedex to win a free swag from their merch store. | [Details](https://dev.to/codedex/how-to-contribute-to-hacktoberfest-with-codedex-8h9) |
| [DagsHub](https://dagshub.com/) | ![Other](icons/other.png) ![Shirt](icons/shirt.png) ![Stickers](icons/stickers.png) ![Swag](icons/swag.png) | Contribute to [Papers with everything](https://github.com/DagsHub/papers-with-everything) or [3D models datasets](https://github.com/DagsHub/3D-model-datasets) by submitting 2 PRs to get swag and 10 PRs to get a full swag package which includes reusable bottle, t-shirt, stickers, DagsHub plush toy and more. | [Details](https://dagshub.com/blog/dagshub-x-hacktoberfest-2022/) |
| [daily.dev](https://daily.dev) | ![Shirt](icons/shirt.png) ![Stickers](icons/stickers.png) ![Swag](icons/swag.png) | Create or find the best memes, submit a PR to our [repo](https://github.com/dailydotdev/memetoberfest). The 10 best memes will get daily.dev SWAG! Please note, that contributions do NOT count towards your goal at the official Hacktoberfest event. | [Details](https://twitter.com/dailydotdev/status/1580070255728246784) |
| [devICT](https://www.devict.org) | ![Stickers](icons/stickers.png) | Create two PRs in any of the [qualifying Wichita repos](https://github.com/devict/hacktoberfest). | [Details](https://devict-hacktoberfest.herokuapp.com/) |
| [Devtron](https://devtron.ai) | ![Other](icons/other.png) ![Shirt](icons/shirt.png) ![Swag](icons/swag.png) | Devtron are running multiple events, you can contribute by blogging, writing twitter threads, creating arts, reporting bugs and fixing open issues. Each category has multiple prizes which include swag kits, tablets, speakers and more. Read their [contributing guide](https://github.com/devtron-labs/hacktoberfest2022) for more information | [Details](https://github.com/devtron-labs/hacktoberfest2022) |
| [dyrector.io](https://docs.dyrector.io/) | ![Swag](icons/swag.png) | Win a dyrector.io swag cap by improving the coverage to more than 10% in the golang side of [this repository](https://github.com/dyrector-io/dyrectorio/issues/241). | [Details](https://github.com/dyrector-io/dyrectorio/issues/241) |
...
| [Globo](https://globo.com/) | ![Shirt](icons/shirt.png) | Contribute with at least 2 PRs. The first 100 registrants to get at least 1PR accepted will win a t-shirt. Find the list of Globo's participating open-source projects [here](https://hacktoberfest.globo.com/). | [Details](https://hacktoberfest.globo.com/) |
...
| [Hasura](https://hasura.io) | ![Shirt](icons/shirt.png) ![Stickers](icons/stickers.png) | Submit a PR to solve one or more issues in [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) repo, to get the chance to win an exclusive t-shirt, and a sticker pack. | [Details](https://hasura.io/blog/with-hasura-celebrate-open-source-in-style-with-hacktoberfest/) |
| [Invertase](https://invertase.io) | ![Mug](icons/mug.png) ![Other](icons/other.png) ![Shirt](icons/shirt.png) ![Stickers](icons/stickers.png) ![Swag](icons/swag.png) | Create one or more merged pull requests. A list of eligible issues can be found [here](https://invertase.link/hf-issues). Each repository has its own contributing guide, named CONTRIBUTING.md, make sure to read it before you start. | [Details](https://invertase.io/community/hacktoberfest) |
...
| [JuliaActuary](https://juliaactuary.org/) | ![Stickers](icons/stickers.png) | Submit at least two contributions to win JuliaActuary stickers. Checkout the [project board](https://github.com/orgs/JuliaActuary/projects/3) for some issues or check  the [hacktoberfest](https://github.com/search?q=org%3AJuliaActuary+label%3Ahacktoberfest+type%3Aissues&type=issues) tagged issues. | [Details](https://juliaactuary.org/blog/hacktoberfest2022/) |
...
| [Modtoberfest](https://modtoberfest.com/) | ![Stickers](icons/stickers.png) | Modtoberfest is an annual celebration of open source projects in the Minecraft community. By contributing valid PRs to four different projects, you are eligible to win a prize pack which includes stickers and pins. | [Details](https://modtoberfest.com/rules) |
| [NativeScript](https://nativescript.org/) | ![Swag](icons/swag.png) | Contribute by creating a stackblitz using NativeScript, submit a PR or share are NativeScript gist. All contributors will receive free swag by sharing it on twitter, tagging them @NativeScript and DM them to receive free swag. | [Details](https://twitter.com/NativeScript/status/1577660072150196224) |
| [Neo4j](https://neo4j.com/) | ![Swag](icons/swag.png) | Contribute by making improvements to their documentation (fix typos, clarify explanations, add code-examples), updating example projects, or fixing open issues in their [repos](https://github.com/search?l=&o=desc&q=neo4j&s=&type=Repositories). To be eligible for the special prize, a Pixoo display, tweet your pull requests at Neo4j with \#hacktoberfest \#neo4j and they will pick the winner in November. | [Details](https://medium.com/neo4j/hacktoberfest-at-neo4j-9991ccc98c33) |
...
| [OpenMetadata](https://open-metadata.org) | ![Other](icons/other.png) ![Swag](icons/swag.png) | Submit a new connector with valid documentation by following their contribution guidelines. Each valid connector will receive $500 USD cash prize and swag. | [Details](https://blog.open-metadata.org/hacktoberfest-2022-connector-extravaganza-c2c88a5823b0) |
| [OpenReplay](https://openreplay.com/) | ![Other](icons/other.png) | Contribute by creating custom plugins or custom heuristics for [OpenReplay](https://github.com/openreplay/openreplay). Top 3 contributors will win a $50 Amazon Card. | [Details](https://blog.openreplay.com/its-hacktoberfest-and-were-here-for-it/) |
...
| [Razorpay](https://razorpay.com/) | ![Shirt](icons/shirt.png) ![Stickers](icons/stickers.png) | Make one or more contribution to open [issues](https://github.com/search?q=org%3Arazorpay+is%3Aissue+is%3Aopen) in the repositories with `hacktoberfest` label under the [Razorpay](https://github.com/razorpay) organisation to win stickers. Top conntributor will receive a custom Razorpay t-shirt. | [Details](https://github.com/razorpay/.github/blob/master/HACKTOBERFEST.md) |
...
| [Resuminator](https://www.resuminator.in/) | ![Shirt](icons/shirt.png) ![Stickers](icons/stickers.png) | Every contributor will receive a swag for their contribution. Contributions of all kind are welcome. You must have a Resuminator account to claim your swag. | [Details](https://github.com/resuminator/resuminator/issues/149) |
...
| [SpaceJelly](https://spacejelly.dev) | ![Stickers](icons/stickers.png) ![Swag](icons/swag.png) | Valid merged PRs to [Next.js WordPress Starter](https://github.com/colbyfayock/next-wordpress-starter) will receive SpaceJelly sticker pack. And valid merged PRs to [Cloudinary Next.js Image Component](https://github.com/colbyfayock/next-cloudinary) or [Cloudinary Netlify Plugin](https://github.com/colbyfayock/netlify-plugin-cloudinary) will receive SpaceJelly sticker pack, Cloudinary sticker pack and plush unicorn | [Details](https://spacejelly.dev/hacktoberfest/) |
...
| [StepZen](https://stepzen.com/) | ![Swag](icons/swag.png) | Contribute by creating new integrations or improve existing integrations. All contributors will receive StepZen goodies | [Details](https://stepzen.com/blog/stepzen-hacktoberfest-2022) |
...
| [Webkul](https://webkul.com/) | ![Other](icons/other.png) ![Shirt](icons/shirt.png) ![Stickers](icons/stickers.png) ![Swag](icons/swag.png) | For every 4 accepted PRs in [Bagisto repo](https://github.com/bagisto/bagisto) you can get a plush Elephant and a swag bag which includes a t-shirt, stickers, pen and notebook. | [Details](https://webkul.com/meetups/hacktober-fest-bagisto-2022/) |
| [Zyte](https://www.zyte.com/) | ![Swag](icons/swag.png) | Contribute with code, translations, blogs, or art to any of 4 open-source projects Zyte maintains which inclues [Scrapy](https://github.com/scrapy), [ScrapingHub](https://github.com/scrapinghub/), [Scrapy Plugins](https://github.com/scrapy-plugins/) and [Zytedata](https://github.com/zytedata). First 20 particiapnts will win Zyte Swag. | [Details](https://www.zyte.com/blog/hacktoberfest-2022/) |
<!-- verified end -->
