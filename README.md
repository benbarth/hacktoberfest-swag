...
| [Appwrite](https://appwrite.io) | ![Shirt](icons/shirt.png) ![Socks](icons/socks.png) ![Stickers](icons/stickers.png) | Participate by creating one or more merged pull requests to any [Appwrite repository](https://github.com/appwrite). Get limited edition socks and sticker-pack for making 3 and also a tshirt for 4 PRs. | [Details](https://hacktoberfest.appwrite.io/) |
