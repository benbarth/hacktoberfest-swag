...
| | | | |
| [Appwrite](https://appwrite.io) | ![Shirt](icons/shirt.png) ![Socks](icons/socks.png) ![Stickers](icons/stickers.png) | Create one or more merged pull requests to any Appwrite repository <https://github.com/appwrite>. _Stickers, Magnets, Buttons, and T-shirts_ | [Details](https://hacktoberfest.appwrite.io/) |
