...
| [CrioDO](https://www.crio.do/) | ![Shirt](icons/shirt.png) ![Stickers](icons/stickers.png) ![Swag](icons/swag.png) | For getting Swags the person should be registered and should be in Top 50 contributors. Top 5 contributors gets 50% scholarship on any of their programs, and Top 10 get 25% scholarship on any of their programs. | [Details](https://www.crio.do/ibelieveindoing) |
| [Datenanfragen.de e. V.](https://www.datarequests.org) | ![Shirt](icons/shirt.png) ![Stickers](icons/stickers.png) | The first 100 participants who submit a pull request or a patch that is accepted by us to one of the qualifying repositories between October 1, 2020 and November 1, 2020, will get a free sticker set. In addition, we are awarding 10 t-shirts for the best contributions. Our board will select those winners after the event is over. | [Details](https://www.datarequests.org/blog/hacktoberfest-2020/) |
...
| [Earthly](https://www.earthly.dev) | ![Stickers](icons/stickers.png) | Contribute code to the Earthly open source build tool or contribute an Earthfile build to any public repo. Top 40 will get Limited-Edition Sticker | [Details](https://blog.earthly.dev/hacktoberfest-2020) |
...
| [LoginRadius](https://www.loginradius.com) | ![Shirt](icons/shirt.png) ![Stickers](icons/stickers.png) | Make one successful pull request in October 2020 to any open source [LoginRadius repository](https://github.com/LoginRadius) and earn a T-shirt and Swags! Only top 500 contributors are eligible for swags and T-shirts. | [Details](https://www.loginradius.com/engineering/blog/loginradius-supports-hacktoberfest-2020) |
