...
| | | | |
| [Appwrite](https://appwrite.io) | ![Mug](icons/mug.png) ![Shirt](icons/shirt.png) ![Stickers](icons/stickers.png) | At present, no exact details are known, but it can be assumed that nothing has changed compared to last year: Create one or more merged pull requests to any Appwrite repository <https://github.com/appwrite>. _Stickers, Magnets, Buttons, and T-shirts_ | [Details](https://hacktoberfest.appwrite.io/) |
