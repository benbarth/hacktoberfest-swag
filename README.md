...
| Hasura | ![Shirt](icons/tshirt-greyscale.png) ![Stickers](icons/stickers-greyscale.png) | "Make a PR on any of these: [The Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) or [The GraphQL Tutorial Series](https://github.com/hasura/learn-graphql) PRs merged into the " | <https://blog.hasura.io/hasura-joins-hacktoberfest-2019/> (Verified 2019) |
