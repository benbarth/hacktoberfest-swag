...
| OpenBazaar | 👕 | Contribute to OpenBazaar. Could be not only GitHub contribution (see the blogbost for more details). | <https://openbazaar.org/blog/Hacktoberfest-with-OpenBazaar-Help-Make-Trade-Free-Get-Rewards> |
