...
| [Novu](https://novu.co/) | ![Shirt](icons/shirt.png) ![Stickers](icons/stickers.png) | Join Novu's community on [Discord](https://discord.gg/novu) and create 3 or more merged pull requests to [Novu's main repository](https://github.com/novuhq/novu). You could also submit an no-code PR in form of an article or a blog post. For content contribution contact the community moderators. | [Details](https://github.com/novuhq/novu/issues/1280) |
<!-- verified end -->
